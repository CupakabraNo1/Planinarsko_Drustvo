...
<body>
	...
	<c:if test="${! empty loguj }">
		...
		<form action="${pageContext.request.contextPath}/login" method="post">
			<fieldset>
				...
				<label for="username">Korisničko ime</label> <input type="text"
					name="username"><br> <label for="password">Lozinka</label>
		...
		<a
		href="${pageContext.request.contextPath}/registruj">Registruj
		se</a>
	</c:if>
		...
		<form action="${pageContext.request.contextPath}/registracija"
			...
			<fieldset>
				...
				<label for="prezime">Prezime</label> <input type="text"
					name="prezime"> <br> <label for="korisnicko_ime">Korisničko
					ime</label><input type="text" name="korisnicko_ime"><br> <label
					for="lozinka">Lozinka</label><input type="password" name="lozinka">
				<input type="submit" value="Prijavi se">
			</fieldset>
		</form>
		<a
		href="${pageContext.request.contextPath}/logovanje">Prijavi
		se</a>
	</c:if>
</body>
</html>